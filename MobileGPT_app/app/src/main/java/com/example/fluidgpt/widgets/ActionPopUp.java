...
public class ActionPopUp {
    private static final String TAG = "FLUID_ACTION_POPUP";
    Context mContext;
    FluidClient mClient;
    ...
    public ActionPopUp(Context context, FluidClient client) {
        mContext = context;
        mClient = client;
    ...
    public void sendModifiedAction() {
        ...
        ((FluidAccessibilityService)mContext).sendModifiedActions(actionHistory);
